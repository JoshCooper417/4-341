...
__fresh184:
  ...
  %size_entry_ptr562 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* @arr556, i32 0, i32 0
  %size563 = load i32* %size_entry_ptr562
  call void @oat_array_bounds_check( i32 %size563, i32 1 )
  %index_ptr561 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* @arr556, i32 0, i32 1, i32 1
  %size_entry_ptr565 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* @arr556, i32 0, i32 0
  %size566 = load i32* %size_entry_ptr565
  call void @oat_array_bounds_check( i32 %size566, i32 1 )
  %index_ptr564 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* @arr556, i32 0, i32 1, i32 1
  %_lhs567 = load { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }** @arr556
  ret { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %_lhs567
}
