...
__fresh862:
  ...
  %_lhs2826 = load i32* %index_ptr2823
  %v2827 = alloca i32
  store i32 %_lhs2826, i32* %v2827
...
__body851:
  ...
  %_lhs2845 = load i32* %index_ptr2842
  ...
  %_lhs2851 = load i32* %index_ptr2848
  %bop2852 = icmp slt i32 %_lhs2845, %_lhs2851
...
__merge853:
  ...
  %_lhs2860 = load i32* %index_ptr2857
  ...
  %_lhs2866 = load i32* %index_ptr2863
  %bop2867 = icmp slt i32 %_lhs2860, %_lhs2866
...
__then861:
  ...
  %_lhs2879 = load i32* %index_ptr2876
  store i32 %_lhs2879, i32* %index_ptr2872
...
__post850:
  ...
  store i32 %_lhs2887, i32* %index_ptr2884
  ret void
}
...
__fresh847:
  ...
  %_lhs2786 = load i32* %index_ptr2783
  %v2787 = alloca i32
  store i32 %_lhs2786, i32* %v2787
  br label %__cond846
...
__cond846:
  ...
  %_lhs2795 = load i32* %index_ptr2792
...
__body845:
  ...
  %_lhs2808 = load i32* %index_ptr2805
  store i32 %_lhs2808, i32* %index_ptr2800
...
__post844:
  ...
  store i32 %_lhs2815, i32* %index_ptr2812
  ret void
}
...
__end819:
  ...
  %_lhs2705 = load i32* %index_ptr2702
  %check2706 = alloca i32
  store i32 %_lhs2705, i32* %check2706
  ...
  %_lhs2713 = load i32* %index_ptr2710
  store i32 %_lhs2713, i32* %index_ptr2707
...
__body821:
  ...
  %_lhs2725 = load i32* %index_ptr2722
  %unop2726 = sub i32 0, %_lhs2725
  store i32 %unop2726, i32* %index_ptr2718
...
__body824:
  ...
  %_lhs2739 = load i32* %index_ptr2736
  store i32 %_lhs2739, i32* %temp2735
  ...
  %_lhs2747 = load i32* %index_ptr2744
  store i32 %_lhs2747, i32* %index_ptr2740
  ...
  store i32 %_lhs2752, i32* %index_ptr2749
...
__body827:
  ...
  %_lhs2767 = load i32* %index_ptr2764
  %_lhs2768 = load i32* %check2706
  %bop2769 = icmp sge i32 %_lhs2767, %_lhs2768
...
__then831:
  ...
  %_lhs2774 = load i32* %index_ptr2771
  store i32 %_lhs2774, i32* %check2706
  br label %__merge829
