...
__fresh192:
  ...
  %size_entry_ptr599 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %arr597, i32 0, i32 0
  %size600 = load i32* %size_entry_ptr599
  call void @oat_array_bounds_check( i32 %size600, i32 1 )
  %index_ptr598 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %arr597, i32 0, i32 1, i32 1
  %size_entry_ptr602 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %arr597, i32 0, i32 0
  %size603 = load i32* %size_entry_ptr602
  call void @oat_array_bounds_check( i32 %size603, i32 1 )
  %index_ptr601 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %arr597, i32 0, i32 1, i32 1
  %_lhs604 = load { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }** %arr597
  ret { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %_lhs604
}
