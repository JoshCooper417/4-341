...
__fresh179:
  ...
  %size_entry_ptr541 = getelementptr { i32, [ 0 x i32 ] }* @arr535, i32 0, i32 0
  %size542 = load i32* %size_entry_ptr541
  call void @oat_array_bounds_check( i32 %size542, i32 1 )
  %index_ptr540 = getelementptr { i32, [ 0 x i32 ] }* @arr535, i32 0, i32 1, i32 1
  %_lhs543 = load { i32, [ 0 x i32 ] }** @arr535
  ret { i32, [ 0 x i32 ] }* %_lhs543
}
