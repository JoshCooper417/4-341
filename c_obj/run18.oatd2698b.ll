...
__fresh0:
  ...
  %size_entry_ptr15 = getelementptr { i32, [ 0 x i32 ] }* %a13, i32 0, i32 0
  %size16 = load i32* %size_entry_ptr15
  call void @oat_array_bounds_check( i32 %size16, i32 2 )
  %index_ptr14 = getelementptr { i32, [ 0 x i32 ] }* %a13, i32 0, i32 1, i32 2
  %_lhs17 = load { i32, [ 0 x i32 ] }** %a13
  ret { i32, [ 0 x i32 ] }* %_lhs17
}
