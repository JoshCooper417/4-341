...
__fresh0:
  ...
  %size_entry_ptr9 = getelementptr { i32, [ 0 x i32 ] }* %arr7, i32 0, i32 0
  %size10 = load i32* %size_entry_ptr9
  call void @oat_array_bounds_check( i32 %size10, i32 1 )
  %index_ptr8 = getelementptr { i32, [ 0 x i32 ] }* %arr7, i32 0, i32 1, i32 1
  %_lhs11 = load i32* %index_ptr8
  %sum12 = alloca i32
  store i32 %_lhs11, i32* %sum12
  %_lhs13 = load i32* %sum12
  ret i32 %_lhs13
}
