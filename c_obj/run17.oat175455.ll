...
__end1022:
  ...
  %size_entry_ptr3401 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %b3396, i32 0, i32 0
  %size3402 = load i32* %size_entry_ptr3401
  call void @oat_array_bounds_check( i32 %size3402, i32 3 )
  %index_ptr3400 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %b3396, i32 0, i32 1, i32 3
  %_lhs3403 = load { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }** %b3396
  ret { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %_lhs3403
}
