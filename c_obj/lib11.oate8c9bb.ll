...
__fresh0:
  ...
  %size11 = getelementptr i32* %size_entry_ptr10, i32 0
  call void @oat_array_bounds_check( i32 %size11, i32 0 )
  %index_ptr9 = getelementptr { i32, [ 0 x i32 ] }* %arr8, i32 0, i32 1, i32 0
