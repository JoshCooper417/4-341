...
__fresh198:
  ...
  %size_entry_ptr628 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* @garr619, i32 0, i32 0
  %size629 = load i32* %size_entry_ptr628
  call void @oat_array_bounds_check( i32 %size629, i32 1 )
  %index_ptr627 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* @garr619, i32 0, i32 1, i32 1
  %_lhs630 = load { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }** @garr619
  %ret631 = call { i32, [ 0 x i32 ] }* @f ( { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %_lhs630 )
  %arr632 = alloca { i32, [ 0 x i32 ] }*
  store { i32, [ 0 x i32 ] }* %ret631, { i32, [ 0 x i32 ] }** %arr632
  %size_entry_ptr634 = getelementptr { i32, [ 0 x i32 ] }* %arr632, i32 0, i32 0
  %size635 = load i32* %size_entry_ptr634
  call void @oat_array_bounds_check( i32 %size635, i32 1 )
  %index_ptr633 = getelementptr { i32, [ 0 x i32 ] }* %arr632, i32 0, i32 1, i32 1
  %_lhs636 = load { i32, [ 0 x i32 ] }** %arr632
