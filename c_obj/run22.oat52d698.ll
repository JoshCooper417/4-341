...
__fresh396:
  ...
  %size_ptr896 = getelementptr { i32, [ 0 x i8* ] }* @strs888, i32 0, i32 0
  call void @oat_array_bounds_check( i32 %size_ptr896, i32 0 )
  %index_ptr895 = getelementptr { i32, [ 0 x i8* ] }* @strs888, i32 0, i32 1, i32 0
  %_lhs897 = load { i32, [ 0 x i8* ] }** @strs888
  call void @print_string( { i32, [ 0 x i8* ] }* %_lhs897 )
  ret i32 0
}
