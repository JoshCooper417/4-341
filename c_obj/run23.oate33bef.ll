...
__fresh319:
  ...
  %size_entry_ptr975 = getelementptr { i32, [ 0 x { i32, [ 0 x i8* ] }* ] }* @strs962, i32 0, i32 0
  %size976 = load i32* %size_entry_ptr975
  call void @oat_array_bounds_check( i32 %size976, i32 1 )
  %index_ptr974 = getelementptr { i32, [ 0 x { i32, [ 0 x i8* ] }* ] }* @strs962, i32 0, i32 1, i32 1
  %_lhs977 = load { i32, [ 0 x { i32, [ 0 x i8* ] }* ] }** @strs962
  call void @print_string( { i32, [ 0 x { i32, [ 0 x i8* ] }* ] }* %_lhs977 )
  ret i32 0
}
