...
__body968:
  ...
  %size_entry_ptr3298 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %ar_slot3284, i32 0, i32 0
  %size3299 = load i32* %size_entry_ptr3298
  call void @oat_array_bounds_check( i32 %size3299, i32 %_lhs3292 )
  %index_ptr3297 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %ar_slot3284, i32 0, i32 1, i32 %_lhs3292
  %_lhs3300 = load { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }** %ar_slot3284
  call void @print_int( { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %_lhs3300 )
...
__body959:
  ...
  %size_entry_ptr3264 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %a1_slot3252, i32 0, i32 0
  %size3265 = load i32* %size_entry_ptr3264
  call void @oat_array_bounds_check( i32 %size3265, i32 %_lhs3258 )
  %index_ptr3263 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %a1_slot3252, i32 0, i32 1, i32 %_lhs3258
  %_lhs3266 = load { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }** %a1_slot3252
  ...
  %size_entry_ptr3273 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %a2_slot3250, i32 0, i32 0
  %size3274 = load i32* %size_entry_ptr3273
  call void @oat_array_bounds_check( i32 %size3274, i32 %_lhs3267 )
  %index_ptr3272 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %a2_slot3250, i32 0, i32 1, i32 %_lhs3267
  %_lhs3275 = load { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }** %a2_slot3250
  %bop3276 = mul { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %_lhs3266, %_lhs3275
...
__body951:
  ...
  %size_entry_ptr3234 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %a3_slot3217, i32 0, i32 0
  %size3235 = load i32* %size_entry_ptr3234
  call void @oat_array_bounds_check( i32 %size3235, i32 %_lhs3228 )
  %index_ptr3233 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %a3_slot3217, i32 0, i32 1, i32 %_lhs3228
  ...
  store i32 %ret3240, { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }** %a3_slot3217
...
__body938:
  ...
  %size_entry_ptr3179 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %a3_slot3159, i32 0, i32 0
  %size3180 = load i32* %size_entry_ptr3179
  call void @oat_array_bounds_check( i32 %size3180, i32 %_lhs3173 )
  %index_ptr3178 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %a3_slot3159, i32 0, i32 1, i32 %_lhs3173
  ...
  %size_entry_ptr3187 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %a3_slot3159, i32 0, i32 0
  %size3188 = load i32* %size_entry_ptr3187
  call void @oat_array_bounds_check( i32 %size3188, i32 %_lhs3181 )
  %index_ptr3186 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %a3_slot3159, i32 0, i32 1, i32 %_lhs3181
  %_lhs3189 = load { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }** %a3_slot3159
  ...
  %size_entry_ptr3196 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %a1_slot3163, i32 0, i32 0
  %size3197 = load i32* %size_entry_ptr3196
  call void @oat_array_bounds_check( i32 %size3197, i32 %_lhs3190 )
  %index_ptr3195 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %a1_slot3163, i32 0, i32 1, i32 %_lhs3190
  %_lhs3198 = load { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }** %a1_slot3163
  ...
  %size_entry_ptr3205 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %a2_slot3161, i32 0, i32 0
  %size3206 = load i32* %size_entry_ptr3205
  call void @oat_array_bounds_check( i32 %size3206, i32 %_lhs3199 )
  %index_ptr3204 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %a2_slot3161, i32 0, i32 1, i32 %_lhs3199
  %_lhs3207 = load { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }** %a2_slot3161
  %bop3208 = mul { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %_lhs3198, %_lhs3207
  %bop3209 = add { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %_lhs3189, %bop3208
  store i32 %bop3209, { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }** %a3_slot3159
