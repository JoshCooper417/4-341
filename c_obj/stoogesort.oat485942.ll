...
__body898:
  ...
  %_lhs2991 = load { i32, [ 0 x i32 ] }** %nums2974
  call void @print_int( { i32, [ 0 x i32 ] }* %_lhs2991 )
...
__fresh892:
  ...
  %_lhs2899 = load { i32, [ 0 x i32 ] }** %a_slot2893
  ...
  %_lhs2904 = load { i32, [ 0 x i32 ] }** %a_slot2893
  %bop2905 = icmp slt { i32, [ 0 x i32 ] }* %_lhs2899, %_lhs2904
...
__then888:
  ...
  %_lhs2910 = load { i32, [ 0 x i32 ] }** %a_slot2893
  store { i32, [ 0 x i32 ] }* %_lhs2910, i32* %t2894
  ...
  %_lhs2919 = load { i32, [ 0 x i32 ] }** %a_slot2893
  store { i32, [ 0 x i32 ] }* %_lhs2919, { i32, [ 0 x i32 ] }** %a_slot2893
  ...
  store i32 %_lhs2924, { i32, [ 0 x i32 ] }** %a_slot2893
  br label %__merge886
