...
__end303:
  ...
  %size_entry_ptr920 = getelementptr { i32, [ 0 x i32 ] }* %index_ptr916, i32 0, i32 0
  %size921 = load i32* %size_entry_ptr920
  call void @oat_array_bounds_check( i32 %size921, i32 1 )
  %index_ptr919 = getelementptr { i32, [ 0 x i32 ] }* %index_ptr916, i32 0, i32 1, i32 1
  %_lhs922 = load i32* %index_ptr919
  ret i32 %_lhs922
}
