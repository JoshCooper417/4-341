...
__fresh1034:
  ...
  %size_entry_ptr3439 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %a3434, i32 0, i32 0
  %size3440 = load i32* %size_entry_ptr3439
  call void @oat_array_bounds_check( i32 %size3440, i32 3 )
  %index_ptr3438 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %a3434, i32 0, i32 1, i32 3
  %_lhs3441 = load { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }** %a3434
  ret { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %_lhs3441
}
