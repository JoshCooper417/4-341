...
__fresh1006:
  ...
  %size_entry_ptr3345 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* @arr3336, i32 0, i32 0
  %size3346 = load i32* %size_entry_ptr3345
  call void @oat_array_bounds_check( i32 %size3346, i32 3 )
  %index_ptr3344 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* @arr3336, i32 0, i32 1, i32 3
  %_lhs3347 = load { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }** @arr3336
  ret { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %_lhs3347
}
