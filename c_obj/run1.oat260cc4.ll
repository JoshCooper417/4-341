...
__post160:
  ...
  %_lhs488 = load { i32, [ 0 x i32 ] }** %arr471
  %ret489 = call i32 @f ( { i32, [ 0 x i32 ] }* %_lhs488 )
  ...
  %size_entry_ptr495 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* @garr451, i32 0, i32 0
  %size496 = load i32* %size_entry_ptr495
  call void @oat_array_bounds_check( i32 %size496, i32 1 )
  %index_ptr494 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* @garr451, i32 0, i32 1, i32 1
  %_lhs497 = load { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }** @garr451
  %ret498 = call i32 @f ( { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %_lhs497 )
...
__fresh159:
  ...
  %_lhs460 = load { i32, [ 0 x i32 ] }** %y_slot456
  ret { i32, [ 0 x i32 ] }* %_lhs460
}
