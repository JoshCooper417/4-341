...
__body923:
  ...
  %_lhs3087 = load { i32, [ 0 x i32 ] }** %ar3078
  call void @print_int( { i32, [ 0 x i32 ] }* %_lhs3087 )
...
__body917:
  ...
  %_lhs3047 = load { i32, [ 0 x i32 ] }** %a_slot3032
  store { i32, [ 0 x i32 ] }* %_lhs3047, i32* %t3033
  ...
  %_lhs3056 = load { i32, [ 0 x i32 ] }** %a_slot3032
  store { i32, [ 0 x i32 ] }* %_lhs3056, { i32, [ 0 x i32 ] }** %a_slot3032
  ...
  store i32 %_lhs3061, { i32, [ 0 x i32 ] }** %a_slot3032
...
__fresh911:
  ...
  %_lhs3006 = load { i32, [ 0 x i32 ] }** %a_slot2999
  %min3007 = alloca i32
  store { i32, [ 0 x i32 ] }* %_lhs3006, i32* %min3007
...
__body906:
  ...
  %_lhs3017 = load { i32, [ 0 x i32 ] }** %a_slot2999
  %_lhs3018 = load i32* %min3007
  %bop3019 = icmp slt { i32, [ 0 x i32 ] }* %_lhs3017, %_lhs3018
...
__then910:
  ...
  %_lhs3024 = load { i32, [ 0 x i32 ] }** %a_slot2999
  store { i32, [ 0 x i32 ] }* %_lhs3024, i32* %min3007
