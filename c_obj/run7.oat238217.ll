...
__fresh1012:
  ...
  %size_entry_ptr3369 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* @arr3360, i32 0, i32 0
  %size3370 = load i32* %size_entry_ptr3369
  call void @oat_array_bounds_check( i32 %size3370, i32 0 )
  %index_ptr3368 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* @arr3360, i32 0, i32 1, i32 0
  %_lhs3371 = load { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }** @arr3360
  ret { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %_lhs3371
}
