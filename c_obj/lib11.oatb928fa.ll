...
__fresh0:
  ...
  %unop9 = sub i32 0, 1
  %index_ptr10 = getelementptr { i32, [ 0 x i32 ] }** %arr8, i32 0, i32 1, i32 0
  store i32 %unop9, i32* %index_ptr10
  call void @oat_array_bounds_check( i32 %size13, i32 %unop9 )
  %index_ptr11 = getelementptr { i32, [ 0 x i32 ] }* %arr8, i32 0, i32 1, i32 %unop9
