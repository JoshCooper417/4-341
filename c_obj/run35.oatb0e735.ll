...
__body73:
  ...
  %size_entry_ptr271 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* @a252, i32 0, i32 0
  %size272 = load i32* %size_entry_ptr271
  call void @oat_array_bounds_check( i32 %size272, i32 %_lhs265 )
  %index_ptr270 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* @a252, i32 0, i32 1, i32 %_lhs265
  %_lhs273 = load { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }** @a252
