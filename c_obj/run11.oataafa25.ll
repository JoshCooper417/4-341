...
__fresh208:
  ...
  %size_entry_ptr707 = getelementptr { i32, [ 0 x i32 ] }* %index_ptr703, i32 0, i32 0
  %size708 = load i32* %size_entry_ptr707
  call void @oat_array_bounds_check( i32 %size708, i32 1 )
  %index_ptr706 = getelementptr { i32, [ 0 x i32 ] }* %index_ptr703, i32 0, i32 1, i32 1
  %_lhs709 = load i32* %index_ptr706
