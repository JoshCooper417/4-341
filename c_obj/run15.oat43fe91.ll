...
__end271:
  ...
  %size_entry_ptr861 = getelementptr { i32, [ 0 x i32 ] }* %index_ptr857, i32 0, i32 0
  %size862 = load i32* %size_entry_ptr861
  call void @oat_array_bounds_check( i32 %size862, i32 4 )
  %index_ptr860 = getelementptr { i32, [ 0 x i32 ] }* %index_ptr857, i32 0, i32 1, i32 4
  %_lhs863 = load i32* %index_ptr860
  ...
  %size_entry_ptr868 = getelementptr { i32, [ 0 x i32 ] }* %index_ptr864, i32 0, i32 0
  %size869 = load i32* %size_entry_ptr868
  call void @oat_array_bounds_check( i32 %size869, i32 2 )
  %index_ptr867 = getelementptr { i32, [ 0 x i32 ] }* %index_ptr864, i32 0, i32 1, i32 2
  %_lhs870 = load i32* %index_ptr867
  %bop871 = add i32 %_lhs863, %_lhs870
...
__end252:
  ...
  %size_entry_ptr820 = getelementptr { i32, [ 0 x i32 ] }* %index_ptr816, i32 0, i32 0
  %size821 = load i32* %size_entry_ptr820
  call void @oat_array_bounds_check( i32 %size821, i32 1 )
  %index_ptr819 = getelementptr { i32, [ 0 x i32 ] }* %index_ptr816, i32 0, i32 1, i32 1
  %_lhs822 = load i32* %index_ptr819
  ret i32 %_lhs822
}
...
__fresh246:
  ...
  %size_entry_ptr797 = getelementptr { i32, [ 0 x i32 ] }* %index_ptr793, i32 0, i32 0
  %size798 = load i32* %size_entry_ptr797
  call void @oat_array_bounds_check( i32 %size798, i32 1 )
  %index_ptr796 = getelementptr { i32, [ 0 x i32 ] }* %index_ptr793, i32 0, i32 1, i32 1
  %_lhs799 = load i32* %index_ptr796
  ret i32 %_lhs799
}
