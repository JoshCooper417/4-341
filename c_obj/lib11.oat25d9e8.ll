...
__body1:
  %index_ptr9 = getelementptr { i32, [ 0 x i32 ] }* %array6, i32* %index_ptr8
  %i11 = load i32* %index_ptr8
  %_lhs12 = load i32* %i11
  %index_ptr9 = load i32* %i11
...
__end2:
  ...
  call void @oat_array_bounds_check( i32 %size16, i32 0 )
  %index_ptr14 = getelementptr { i32, [ 0 x i32 ] }* %arr13, i32 0, i32 1, i32 0
