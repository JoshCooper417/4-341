...
__fresh208:
  ...
  %size_entry_ptr698 = getelementptr { i32, [ 0 x i32 ] }* @arr1643, i32 0, i32 0
  %size699 = load i32* %size_entry_ptr698
  call void @oat_array_bounds_check( i32 %size699, i32 1 )
  %index_ptr697 = getelementptr { i32, [ 0 x i32 ] }* @arr1643, i32 0, i32 1, i32 1
  %_lhs700 = load { i32, [ 0 x i32 ] }** @arr1643
  %bop701 = add i32 %_lhs696, %_lhs700
  store i32 %bop701, i32* %c683
  %_lhs702 = load i32* %c683
  %size_entry_ptr704 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* @arr2664, i32 0, i32 0
  %size705 = load i32* %size_entry_ptr704
  call void @oat_array_bounds_check( i32 %size705, i32 1 )
  %index_ptr703 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* @arr2664, i32 0, i32 1, i32 1
  %size_entry_ptr707 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* @arr2664, i32 0, i32 0
  %size708 = load i32* %size_entry_ptr707
  call void @oat_array_bounds_check( i32 %size708, i32 1 )
  %index_ptr706 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* @arr2664, i32 0, i32 1, i32 1
  %_lhs709 = load { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }** @arr2664
  %bop710 = add i32 %_lhs702, %_lhs709
  store i32 %bop710, i32* %c683
  %_lhs711 = load i32* %c683
  %size_entry_ptr713 = getelementptr { i32, [ 0 x i32 ] }* %arr3692, i32 0, i32 0
  %size714 = load i32* %size_entry_ptr713
  call void @oat_array_bounds_check( i32 %size714, i32 3 )
  %index_ptr712 = getelementptr { i32, [ 0 x i32 ] }* %arr3692, i32 0, i32 1, i32 3
  %_lhs715 = load { i32, [ 0 x i32 ] }** %arr3692
  ...
  %size_entry_ptr723 = getelementptr { i32, [ 0 x i32 ] }* %arr4685, i32 0, i32 0
  %size724 = load i32* %size_entry_ptr723
  call void @oat_array_bounds_check( i32 %size724, i32 1 )
  %index_ptr722 = getelementptr { i32, [ 0 x i32 ] }* %arr4685, i32 0, i32 1, i32 1
  %_lhs725 = load { i32, [ 0 x i32 ] }** %arr4685
...
__fresh206:
  ...
  %size_entry_ptr668 = getelementptr { i32, [ 0 x i32 ] }* %arr_slot666, i32 0, i32 0
  %size669 = load i32* %size_entry_ptr668
  call void @oat_array_bounds_check( i32 %size669, i32 3 )
  %index_ptr667 = getelementptr { i32, [ 0 x i32 ] }* %arr_slot666, i32 0, i32 1, i32 3
  %_lhs670 = load { i32, [ 0 x i32 ] }** %arr_slot666
  ret { i32, [ 0 x i32 ] }* %_lhs670
}
